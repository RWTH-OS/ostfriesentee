...
char dj_global_id_implements(dj_global_id class_id, dj_global_id interface);
...
char dj_global_id_isJavaLangObject(dj_global_id class_id);
...
dj_di_pointer dj_global_id_getClassDefinition(dj_global_id class_id);
